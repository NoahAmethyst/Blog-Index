...
const RECORD_NUMBER = "苏ICP备2023026939号-1"; // 网站备案号，留空不显示
...
const PAGES_DATA = [
    {
        ...
        sortId: 1,
        title: "ChatGpt-Web",
        subtitle: "Free ChagGpt,contact me to gain access code",
        //个人chatgpt-nex-web 链接
        url: "https://noahamethyst.club/chatgpt",
    ...
    },
    {
        pageId: 1,
        sortId: 1,
        title: "Add QQ bot to help you",
        subtitle: "AIGC and other interesting features by interacting with qq",
        //添加qq链接
